    ...
    entry.messaging.map(messagingItem => {
      ...
      getState(event, messagingItem, psid).then(s => {
        ...
        if (messagingItem.postback) {
          ...
          messagingItem.message.text == "Hey" ||
          messagingItem.message.text == "Get started" ||
          messagingItem.message.text == "Get Started" ||
          messagingItem.message.text == "Hello"
        ) {
          console.log("Defining responsePayload for START");
          ...
          console.log(
            "Defining responsePayload for FOOD RATING with Yes response"
          );

          const response1 = {
            text:
              "Awesome my friend, thanks for your support! Show this GIF below to one of our team and we'll give you some free food!"
          };
          ...
          const response2 = {
            attachment: {
              ...
              payload: {
                url:
                  "https://media.giphy.com/media/1wX7kfWNy36E3aBnm0/giphy.gif",
                is_reusable: true
              }
            }
          };
          ...
          const response3 = {
            text:
              "PS. After you have finished eating, press a button to tell us how the food was!",
            quick_replies: [
              {
                content_type: "text",
                title: "👎",
          ...
          const response1 = {
            attachment: {
              type: "image",
              payload: {
                url: "https://media.giphy.com/media/eauCbbW6MvqKI/giphy.gif",
                is_reusable: true
              }
            }
          };
          ...
          console.log(
            "Defining responsePayload for VEGAN FEEDBACK thumbs down"
          );
          const url = `https://graph.facebook.com/v2.6/me/messages?access_token=EAACZBYlTaAHEBAMRW2CKCI0k4MCoxcjOyMkHeTzZCFQEIbWhjUefiEd5grYOMfexPbSCZAAWzSZApZCeRynWupU05ZC3d9Tpnm2dQ9keEXU7klP1xNynqyOZCVVkUYEHqSLa202BaxIra1Ddb1yNBZCcW2ah7YdHZAcx6n9862Y92sxsObm0q2Tee`;
          ...
          return db
            ...
            .promise()
            .then(() =>
              saveFeedback(psid, messagingItem, s).then(() =>
                console.log("I have saved the feedback now")
              )
            );
        } else if (
          s == "GOT SUSTAINABLE REPLY" &&
          ...
          s == "FOOD RATED" &&
          messagingItem.message.text == "WAT?? 😲😱"
        ) {
          console.log("Defining responsePayload for VEGAN FEEDBACK thumbs Up");
          const url = `https://graph.facebook.com/v2.6/me/messages?access_token=EAACZBYlTaAHEBAMRW2CKCI0k4MCoxcjOyMkHeTzZCFQEIbWhjUefiEd5grYOMfexPbSCZAAWzSZApZCeRynWupU05ZC3d9Tpnm2dQ9keEXU7klP1xNynqyOZCVVkUYEHqSLa202BaxIra1Ddb1yNBZCcW2ah7YdHZAcx6n9862Y92sxsObm0q2Tee`;
          ...
          const response1 = {
            text:
              "Make sure you check out these delicious nuggets at Woolworths or Coles:"
          };
          ...
          const response2 = {
            attachment: {
              ...
              payload: {
                ...
                elements: [
                  {
                    title: "Fry's Family Food Nuggets",
                    image_url:
                      "http://www.fryfamilyfood.com/au/wp-content/uploads/2016/09/Chia-Nuggets--550x978.png",
                    subtitle: "Available at Coles and Woolworths!",
                    default_action: {
                      type: "web_url",
                      url:
                        "http://www.fryfamilyfood.com/au/rice-protein-chia-nuggets/",
                    ...
                    buttons: [
                      ...
                      },
                      {
                        type: "web_url",
                        url:
                          "https://www.woolworths.com.au/shop/productdetails/937534/fry-s-meat-free-nuggets-with-rice-protein-chia",
                        title: "Buy Some Nuggets"
                      }
                    ]
                  }
                ]
          ...
          s == "FOOD RATED" &&
          messagingItem.message.text == "Yep 👍"
        ) {
          console.log("Defining responsePayload for VEGAN FEEDBACK thumbs Up");
          const url = `https://graph.facebook.com/v2.6/me/messages?access_token=EAACZBYlTaAHEBAMRW2CKCI0k4MCoxcjOyMkHeTzZCFQEIbWhjUefiEd5grYOMfexPbSCZAAWzSZApZCeRynWupU05ZC3d9Tpnm2dQ9keEXU7klP1xNynqyOZCVVkUYEHqSLa202BaxIra1Ddb1yNBZCcW2ah7YdHZAcx6n9862Y92sxsObm0q2Tee`;
          ...
          s == "GOT VEGAN FEEDBACK" &&
          messagingItem.message.text == "No I'm okay"
        ) {
          console.log("Defining responsePayload for VEGAN FEEDBACK thumbs Up");
          const url = `https://graph.facebook.com/v2.6/me/messages?access_token=EAACZBYlTaAHEBAMRW2CKCI0k4MCoxcjOyMkHeTzZCFQEIbWhjUefiEd5grYOMfexPbSCZAAWzSZApZCeRynWupU05ZC3d9Tpnm2dQ9keEXU7klP1xNynqyOZCVVkUYEHqSLa202BaxIra1Ddb1yNBZCcW2ah7YdHZAcx6n9862Y92sxsObm0q2Tee`;
          ...
          s == "GOT VEGAN FEEDBACK" &&
          messagingItem.message.text == "Obviously"
        ) {
          console.log("Defining responsePayload for VEGAN FEEDBACK thumbs Up");
          const url = `https://graph.facebook.com/v2.6/me/messages?access_token=EAACZBYlTaAHEBAMRW2CKCI0k4MCoxcjOyMkHeTzZCFQEIbWhjUefiEd5grYOMfexPbSCZAAWzSZApZCeRynWupU05ZC3d9Tpnm2dQ9keEXU7klP1xNynqyOZCVVkUYEHqSLa202BaxIra1Ddb1yNBZCcW2ah7YdHZAcx6n9862Y92sxsObm0q2Tee`;
          ...
          const response1 = {
            text:
              "Great! I'll send you a message next time we are on campus. See you later!"
          };
          callSendAPI(messagingItem, callback, response1);
        ...
        // The following options are fallback options for each bot step
          ...
          s == "STARTED" &&
          messagingItem.message.text !== "No" &&
          messagingItem.message.text !== "Yes"
        ) {
          console.log(
            "The whole handler is broken - no matching to state or message text potential error"
          );
          const url = `https://graph.facebook.com/v2.6/me/messages?access_token=EAACZBYlTaAHEBAMRW2CKCI0k4MCoxcjOyMkHeTzZCFQEIbWhjUefiEd5grYOMfexPbSCZAAWzSZApZCeRynWupU05ZC3d9Tpnm2dQ9keEXU7klP1xNynqyOZCVVkUYEHqSLa202BaxIra1Ddb1yNBZCcW2ah7YdHZAcx6n9862Y92sxsObm0q2Tee`;
          ...
          const response1 = {
            text:
              "Sorry, I didnt quite get that. I was wondering what you thought of the food?",
            quick_replies: [
              {
                content_type: "text",
                title: "👎",
          ...
          const response1 = {
            text:
              "Sorry, I didnt quite get that. I just asked if you knew it was plant-based?",
            quick_replies: [
              {
                content_type: "text",
                title: "WAT?? 😲😱",
          ...
          const response1 = {
            text:
              "Sorry, I didnt quite get that. I was asking if you want to hear about more free food in the future?",
            quick_replies: [
              {
                content_type: "text",
                title: "No I'm okay",
          ...
          const response1 = {
            text:
              "Sorry, that's all the tricks I can do for now. If you have any questions though, just send them through and a real person may be able to help"
          };
